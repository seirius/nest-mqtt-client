...
let ProcessStateService = ProcessStateService_1 = class ProcessStateService {
    constructor(mqttService) {
        this.mqttService = mqttService;
        this.logger = new common_1.Logger(ProcessStateService_1.constructor.name);
        this.petitions = [];
    }
    setAsReportListener() {
        this.mqttService.sub({
            channel: process_state_dto_1.PROCESS_STATE_CHANNEL.processReport,
            callback: (payload) => {
    ...
    askForReport({ expect, onReport, feedbackOnEachReport }) {
        ...
        this.mqttService.push({
            channel: process_state_dto_1.PROCESS_STATE_CHANNEL.reportQuestion,
            payload: {
                petitionId,
            },
        });
...
ProcessStateService = ProcessStateService_1 = __decorate([
    common_1.Injectable(),
